        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container text-md-center">
                    <div class="card-header ">Contact Setting
                        <a href="{{route('add.contact')}}" class="btn btn-primary float-right btn-sm">Add contact</a></div>
                    ...
                    <div class="row">
                        ...
                        @endphp --}}
                                @foreach ($contact as $item)
                                    <tr>
                                        <th  scope="row">{{ $contact->firstItem() + $loop->index }}</th>
                                        <td >{{ $item->address }}</td>
                                        <td >{{ $item->email }}</td>
                                        <td >{{ $item->phone }}</td>
