                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="has-sub active expand">
                            ...
                            <ul class="collapse show" id="dashboard" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    ...
                                    <li class="active">
                                        <a class="sidenav-item-link" href="{{route('allslider')}}">
                                    ...
                                    <li class="active">
                                        <a class="sidenav-item-link" href="{{route('allportfolio')}}">
                        ...
                        <li class="has-sub  expand">
                            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                ...
                                <i class="mdi mdi-view-contact-outline"></i>
                            ...
                            <ul class="collapse show" id="contact" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    ...
                                    <li class="active">
                                        <a class="sidenav-item-link" href="{{route('allcontact')}}">
                                            <span class="nav-text">Profile</span>

                                        </a>
                                    </li>
                                    <li class="active">
                                        <a class="sidenav-item-link" href="{{route('allmessage')}}">
