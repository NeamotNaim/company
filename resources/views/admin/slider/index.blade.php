            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container text-md-center">
                    <div class="card-header ">All Slider
                        <a href="{{route('add.slider')}}" class="btn btn-primary float-right btn-sm">Add Slider</a></div>
                    ...
                    <div class="row">
                        ...
                        @endphp --}}
                                @foreach ($slider as $item)
                                    <tr>
                                        <th width="5%" scope="row">{{ $slider->firstItem() + $loop->index }}</th>
                                        ...
                                        <td width="15%">
                                            <a href=" {{ url('slider/edit/' . $item->id) }} "
                                                class="btn btn-sm btn-info">Edit</a>
                                            <a href=" {{ url('slider/delete/' . $item->id) }} "
