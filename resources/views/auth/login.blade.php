          ...
          <div class="card">
            ...
            @endif
              ...
              <form method="POST" action="{{route('login')}}">
                @csrf
                <div class="row">
                  <div class="form-group col-md-12 mb-4" value="{{ __('Email') }}">
                    <input  type="email" class="form-control input-lg" id="email" :value="old('email')" name="email" aria-describedby="emailHelp" placeholder="Username">
                  </div>
                  <div class="form-group col-md-12 " value="{{ __('Password') }}">
                  ...
                  <div class="col-md-12">
                    <div class="d-flex my-2 justify-content-between">
                      <div class="d-inline-block mr-3">
                        <label class="control control-checkbox" id="remember_me" name="remember">Remember me
                          <input type="checkbox" />
